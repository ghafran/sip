...
function RegisterResponse(message) {
    ...
    _self.generate = function () {
        ...
        if(_self.statusCode === 401){
            ...
            var challenge = Digest.createChallenge(realm, domain);
            wwwAuthenticate = 'WWW-Authenticate: Digest realm="' + challenge.realm + '", domain="' + challenge.domain + '", qop="' + challenge.qop + '", nonce="' + challenge.nounce + '", opaque="' + challenge.opaque + '", stale=FALSE, algorithm="' + challenge.algorithm + '"';
        }
